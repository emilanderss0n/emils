...
<div class="call-to-action">
    <div id="scrollAnimateMain">

        <section class="scroller-start panel">
            <div class="scroller-start-wrapper">
                <div class="scroller-start-content">
                    <h1>NHLPLAY demonstrates proficiency in API integration, data caching, responsive design, and creating an intuitive user interface for sports statistics.</h1>
                </div>
            </div>
        </section>

        <section class="portfolio-grid-scroller panel">
            <div class="portfolio-grid-wrapper">
                @foreach($latestWorksGrid as $workItem)
                <div class="portfolio-item">
                    <img src="{{ asset('storage/' . $workItem->thumbnail) }}" loading="lazy" alt="{{ $workItem->name }}">
                </div>
                @endforeach
            </div>
        </section>

        <section class="contact-me panel">
            <div class="content-container">
                <div class="call-content">
                    <h1>Maybe we should work together?</h1>
                    <a class="btn animate-arrow" href="https://emilandersson.com/contact">
